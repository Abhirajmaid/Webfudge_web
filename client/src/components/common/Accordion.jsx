  ...
  return (
    <div className=" border-b-2 border-gray/25  pb-2 ">
      <div
        ...
        onClick={handleShow}
      >
        <h1 className="md:text-[1.1vw] text-[3.5vw] font-[BelfastMedium] tracking-wide font-bold md:pl-2">
          {name}
        </h1>
        {isOpen ? (
      ...
      <p
        className={`p-0 max-h-0 overflow-hidden font-[BelfastMedium] transition-all md:text-[0.9vw] text-[2.5vw] text-full-opacity ${
          isOpen && "isOpen"
        }`}
      >
        {response}
        {url && (
          <Link href={`${url}`} target="_black" className="opacity-100">
            <div className="text-[1.2vw] text-primary font-[BelfastMedium] cursor-pointer hover:opacity-70 ">
